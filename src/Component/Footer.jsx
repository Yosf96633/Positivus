...
const Footer = () => {
  return (
    <footer className=" bg-black text-white py-12 rounded-t-3xl mt-12">
      {/* Footer's header */}
      <header className=" flex max-sm:flex-col justify-between space-y-4 max-sm:items-center px-14 items-center py-2">
        <img className=" h-6" src={logo_white} alt="logo" />
        <nav className=" space-x-6 flex max-sm:flex-col max-sm:space-y-4">
        ...
        <div className=" flex space-x-8 text-3xl max-sm:hidden">
          <SiFacebook />
          <SiLinkedin />
          <SiX/>
        </div>
      ...
      {/* Contact */}
      <div className=" grid grid-cols-2 max-sm:grid-cols-1 gap-4 grid-rows-1 py-6 border-b-[1px] mx-16">
         ...
         <div className=" flex justify-center items-center">
            <div className=" bg-[#292A32] p-12 max-sm:p-6 space-y-4  flex max-sm:flex-col justify-center sm:space-x-4 rounded-2xl">
         ...
         <div className=" sm:hidden flex space-x-12 text-3xl justify-center items-center py-6">
         <SiFacebook />
          <SiLinkedin />
          <SiX/>
         </div>
